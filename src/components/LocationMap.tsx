    ...
    <div className="space-y-6" dir="rtl">
      <div className="rounded-xl overflow-hidden shadow-lg border border-gray-200">
        ...
        <div className="bg-white p-4 flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-lg">شاهد على خرائط جوجل</h3>
          </div>
          <a
            href={googleMapsUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-lg transition-colors shadow-md flex items-center space-x-2 rtl:space-x-reverse"
          >
